...
(function(){
  ...
  function ensureCompatCss(){
    ...
    st.textContent=`
      ...
      .compat-action-row{display:flex;flex-wrap:nowrap;gap:6px;align-items:center}.compat-action-row .btn{white-space:nowrap;flex:0 0 auto}.data-table td.compat-action-row{display:table-cell!important;white-space:nowrap!important;vertical-align:middle!important;min-width:155px!important;width:155px!important}.data-table td.compat-action-row .btn{display:inline-flex!important;flex:0 0 auto!important;width:auto!important;min-width:0!important;margin:0 4px 0 0!important;vertical-align:middle!important}.data-table td.compat-action-row .btn:last-child{margin-right:0!important}.data-table td:last-child{white-space:nowrap!important}
      ...
      .modal-content-panel .scroll-x,.modal-content-panel .table-scroll,.modal-content-panel .table-responsive-logi{width:100%!important;max-width:100%!important;overflow-x:auto!important;overflow-y:auto!important;-webkit-overflow-scrolling:touch!important}.modal-content-panel .data-table{width:max-content!important;min-width:100%!important;max-width:none!important}.modal-content-panel .data-table th,.modal-content-panel .data-table td{white-space:nowrap!important}.modal-content-panel .data-table td.compat-action-row{display:table-cell!important;min-width:155px!important;width:155px!important}.modal-content-panel .data-table td.compat-action-row .btn{display:inline-flex!important;width:auto!important;min-width:58px!important;white-space:nowrap!important;margin:0 4px 0 0!important;vertical-align:middle!important}.modal-content-panel .data-table td.compat-action-row .btn:last-child{margin-right:0!important}.quote-actions,.compat-quote-actions{display:flex!important;flex-wrap:nowrap!important;align-items:center!important;justify-content:center!important;gap:6px!important;white-space:nowrap!important;width:max-content!important;margin:auto!important}.quote-actions .btn,.compat-quote-actions .btn{flex:0 0 auto!important;white-space:nowrap!important;margin:0!important}
      .modal-content-panel .data-table td.compat-quote-actions{display:table-cell!important;width:1%!important;min-width:390px!important;white-space:nowrap!important;text-align:center!important;vertical-align:middle!important}.modal-content-panel .data-table td.compat-quote-actions .btn{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:auto!important;min-width:0!important;height:34px!important;min-height:34px!important;margin:0 3px!important;padding:6px 12px!important;border-radius:8px!important;white-space:nowrap!important;font-size:11px!important;line-height:1!important}.user-name-pill{display:inline-flex!important;align-items:center!important;justify-content:center!important;width:auto!important;min-width:0!important;padding:7px 11px!important;border:1px solid #d8cff4!important;border-radius:9px!important;background:#eeeafb!important;color:#554a74!important;font-size:11px!important;font-weight:800!important;line-height:1!important;white-space:nowrap!important}
      @media(max-width:900px){.compat-toolbar{grid-template-columns:1fr 1fr}.compat-span-2,.compat-span-3,.compat-span-4,.compat-span-6{grid-column:span 1}.compat-span-12{grid-column:1/-1}.compat-form-grid{grid-template-columns:1fr}.compat-rows-head,.compat-row{grid-template-columns:70px 1fr 1fr 1fr 1fr 38px}.modal-content-panel .data-table{min-width:760px!important}.modal-body>.db-tabs{flex-wrap:nowrap!important;overflow-x:auto!important;white-space:nowrap!important}.db-tabs .nav-link{flex:0 0 auto!important}}
    `;
